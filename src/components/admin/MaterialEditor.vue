...
// --- KATEGÓRIA KEZELÉS ---
const availableCategories = ref<string[]>(['Bútorlap', 'Munkapult', 'Hátfal', 'Fém', 'Egyéb']);
...
<template>
    <div class="grid grid-cols-12 gap-6 h-full">
        ...
        <div class="col-span-4 bg-gray-900 rounded-lg p-4 flex flex-col h-full border border-gray-700">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar space-y-4">
                <div v-for="(materials, category) in groupedMaterials" :key="category">
                    <h3
                        class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 sticky top-0 bg-gray-900 py-1">
                        {{ category }}
                    </h3>
                    <div class="space-y-1">
                        <div v-for="mat in materials" :key="mat.id" @click="handleSelect(mat)"
                            ...
                            <!-- Előnézet -->
                            <div
                                class="w-8 h-8 rounded mr-3 border border-gray-600 flex-shrink-0 overflow-hidden relative">
                                <div v-if="mat.type === 'color'" :style="{ backgroundColor: mat.value }"
        ...
        <div
            class="col-span-8 bg-gray-900 rounded-lg p-6 border border-gray-700 h-full overflow-y-auto custom-scrollbar">
                    ...
                    <div class="bg-gray-800 p-4 rounded-lg border border-gray-700">
                        ...
                        <div v-if="selectedMaterial.type === 'color'">
                            ...
                            <div class="flex gap-2">
                                ...
                                <input v-model="selectedMaterial.value" type="text"
                        ...
                        <div v-else>
                            ...
                            <!-- DRAG & DROP ZÓNA -->
                            <div class="border-2 border-dashed border-gray-600 rounded-lg p-4 text-center hover:border-blue-500 transition-colors cursor-pointer relative"
                            ...
                            <input v-model="selectedMaterial.value" type="text"
                                class="admin-input w-full font-mono mt-2"
