...
const {
    ...
    handleUnifiedChange
} = useInspectorGrouping(currentConfig, currentState, selectedObject)
                ...
                <div class="grid grid-cols-3 gap-2 h-8">
                    ...
                    <button v-if="shouldShowMaterialSelector(control.referenceSlot)"
                        ...
                        <div class="w-full h-full flex items-center justify-center bg-gray-800">
                            ...
                            <img v-else :src="getMatThumbnail(control.referenceSlot.slotId)"
                        ...
                        <div v-if="isMaterialInherited(control.referenceSlot)"
                            ...
                            <svg class="w-full h-full" preserveAspectRatio="none">
                                <line x1="0" y1="100%" x2="100%" y2="0" stroke="#ef4444" stroke-width="1.5"
                                    stroke-opacity="0.8" />
                            </svg>
                        </div>
                    </button>
